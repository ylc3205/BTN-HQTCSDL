...
export default function Navbar() {
    return (
        <nav className="flex-none h-12 bg-[#18181B] border-b border-[#27272A] flex items-center justify-between px-4">
            <div className="flex items-center gap-3">
                ...
                <h1 className="text-white font-semibold text-lg tracking-wide hidden sm:block">
                    SQL <span className="text-blue-400">Web</span> Editor
                </h1>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-[#27272A] rounded-full">
